...
exports.author_create_post [
    ...
    body('family_name').isLength({min:1}).trim().withMessage('Family name must be specific')
    .isAlphanumeric().withMessage('Family name has non-alphanumeric characters.'),
    body('date_of_birth','Invalid date of birth').optional({checkFalsy:true}).isISO8601(),
    body('date_of_','Invalid date of death').optional({checkFalsy:true}).isISO8601(),
//SANITIZE fileds
    ...
    (req,res,next)=>{
        ...
        {
            //Data has no errors
            //Create an Authro object with escaped and trimmed data.
